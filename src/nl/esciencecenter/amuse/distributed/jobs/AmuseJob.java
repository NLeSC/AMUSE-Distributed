 ...
 * 
 */
public interface AmuseJob {

    //constructor to read input from message
    //JobDescription(ReadMessage, sandbox);

    void writeInputTo(WriteMessage writeMessage) throws IOException;
