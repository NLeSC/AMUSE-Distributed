 ...
 * 
 */
public final class JobManager extends Thread implements MessageUpcall {
    ...
    public JobManager(AmuseJob job, String label, int numberOfSlots, Ibis ibis, JobSet jobs) throws DistributedAmuseException {
        this.job = job;
        this.label = label;
