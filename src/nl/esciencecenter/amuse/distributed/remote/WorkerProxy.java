...
public class WorkerProxy extends Thread {
    ...
    private final WorkerJob description;
    ...
    private static Process startWorkerProcess(WorkerJob description, AmuseConfiguration amuseConfiguration,
     ...
     */
    public WorkerProxy(WorkerJob description, AmuseConfiguration amuseConfiguration, Ibis ibis, File tempDirectory,
