...
public class DistributedAmuseIT {
    ...
    public void test01_Constructor() throws DistributedAmuseException {
        ...
        da.reservationManager().newPilot("local", "unlimited", 1, 10, 1, "default", "");
        da.reservationManager().waitForAllPilots();
    ...
    public void test02_addResources() throws DistributedAmuseException {
        ...
        da.reservationManager().newPilot("some.name", "all.q", 1, 10, 1, "default", "");
